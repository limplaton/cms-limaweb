...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \Modules\Users\App\Http\Middleware\UpdateUserLastActiveDate::class,
        \Modules\Core\App\Http\Middleware\AddVersionHeaderToResponse::class,
    ];
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \Modules\Core\App\Http\Middleware\BlocksBadVisitors::class,
